...
Diseño
        ...
        <div class="main-banner__img">
          <img alt="Imagen Banner" src="<?php echo get_template_directory_uri(); ?>/assets/img/verificacion.jpg">
        </div>
      </div>
    </div>
  ...
  <div class="container padding-top-bottom" > 
    <div class="container-grid" >
      <div class="general-about__img" >
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/verificacion.png">
      </div>
      <div class="general-about__text justify-content-center" >
        ...
        Lorem ipsum dolor sit amet, consectetur adipisicing elitos, sed do eiusmod tempor incididunt ut labore et dolore los magni nostrud exercitation ullamco laboris nisi utaliquip. x commodo  nulla pariatur aute irure dolor in reprehenderit in voluptate velit consequat.  Duis  esse cillum dolore eu fugiat . </p>
